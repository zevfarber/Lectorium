...
| next | 31–38 | 13–20 | `archive/pp013-020.json` | |
| … | … | … | … | one archive per run |
| end | 931–938 | 913–920 | | then create `DONE` |

**Last PDF page done: 30. Pages remaining: 908. Lines archived: 218. Next retrain of the OCR
model when lines archived pass 400** (then every 200).
