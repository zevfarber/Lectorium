...
| next | 39–46 | 21–28 | `archive/pp021-028.json` | |
| … | … | … | … | one archive per run |
| end | 931–938 | 913–920 | | then create `DONE` |

**Last PDF page done: 38. Pages remaining: 900. Lines archived: 400. Retrained calc.traineddata
this run (400 lines, 13.5%→3.3% CER on batch). Next retrain when lines archived pass 600.**
