# New house renderings proposed from odyssey-012 (3.313–403)

Formulas and epithets used in this part that are not yet in the table in `conventions.md` and will plainly recur. Where a wording was already shipped in a published part but never added to the table, the row fixes that wording and says where it comes from.
